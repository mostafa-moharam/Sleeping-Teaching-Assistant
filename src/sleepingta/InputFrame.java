...
public class InputFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("The sleeping TA Project");

        jLabel2.setText("Number of TAs:");
        ...
        TAs.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1", "2", "3", "4", "5" }));
        TAs.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TAsActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(TAs, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void EnterBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EnterBtnActionPerformed
        try{
        this.TA = Integer.parseInt((String) TAs.getSelectedItem());
        this.students = Integer.parseInt(Students.getText());
        this.chairs = Integer.parseInt((String) Chairs.getSelectedItem());

        SleepingTA sTA = new SleepingTA(students, chairs, TA);
        Session s = new Session(TA, students, chairs);
        s.setSize(970, 542);
        s.setVisible(true);
    ...
    private javax.swing.JComboBox<String> TAs;
